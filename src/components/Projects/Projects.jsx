...
const Projects = () => {
  ...
  return (
    <div id="projects">
      <SectionTitle
        title="Projects"
        subtitle="We put your ideas and thus your wishes in the form of a unique web project that inspires you and you customers."
      />
        ...
        {!showProjectDetails ? (
          projects.map((project, idx) => {
            ...
            return (
              <div
                key={idx}
                className="flex flex-col justify-between bg-slate-900 text-white p-4 rounded-2xl shadow-lg  hover:shadow-xl group"
              >
          ...
          <>
            <div className=" bg-slate-900 text-white p-6 rounded-2xl shadow-lg max-w-5xl mx-auto ">
              <button
                className="btn btn-xs mb-4 bg-purple-700 border-0 text-white"
              ...
              <div className="relative place-items-center  overflow-hidden rounded-lg transition-all">
                ...
                />
                <p
                  className="absolute text-gray-300 font-bold text-justify mt-2 pt-8 px-2 text-sm z-10
              ...
              <h2 className="text-2xl font-bold mt-4 text-violet-400">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {projectDetails.technologies.map((tech, index) => (
                  <span
                    key={index}
                    className="bg-violet-700 text-white text-xs px-3 py-1 rounded-full"
                  >
                    {tech}
                  </span>
                ))}
              </div>
              <h2 className=" font-bold mt-4 text-violet-400">
                Challange Faced:{" "}
                <small className="text-gray-300 font-bold  my-2">
                  {projectDetails.challenges_faced}
                </small>
              </h2>
              <h2 className=" font-bold mt-4 text-violet-400">
                Potential Improvements:{" "}
                <small className="text-gray-300 font-bold  my-2">
                  {projectDetails.potential_improvements}
                </small>
              </h2>
