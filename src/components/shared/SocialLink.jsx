...
const SocialLink = () => {
    return (
        <div className="flex gap-4 text-lg">
            <a href="https://x.com/adibahbab4108" target='_blank' className="text-gray-300 text-3xl hover:text-purple-600">
                <FaTwitter />
            </a>
            <a href="#" className="text-gray-300 text-3xl hover:text-purple-600">
                <FaDribbble />
            </a>
